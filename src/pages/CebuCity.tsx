...
const CebuCity = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <Helmet>
        <title>Kodigo Eleksyon 2025 - Ballot Builder for Cebu City</title>
        <meta name="description" content="Create your personalized Kodigo ballot for the 2025 Philippine elections in Cebu City. Make the voting process faster and easier." />
        <meta name="keywords" content="kodigo, eleksyon, 2025, philippines elections, ballot builder, voting guide, cebu city" />
        <link rel="canonical" href="https://kodigoeleksyon2025.netlify.app/cebu-city" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Create your personalized Kodigo ballot for the 2025 Philippine elections in Cebu City.",
            "url": "https://kodigoeleksyon2025.netlify.app/cebu-city",
      ...
      <main id="main-content" ref={mainContentRef}>
        <div className="container mx-auto max-w-6xl px-6 mt-8 mb-2">
          <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
            <h1 className="text-2xl font-bold text-orange-800 text-center">Cebu City Ballot Builder</h1>
            <p className="text-orange-700 text-center mt-2">
              Create your personalized ballot for the Cebu City 2025 elections
            </p>
          </div>
        </div>
