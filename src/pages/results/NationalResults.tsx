...
import {AlertTriangle, Loader2, Info, Newspaper} from "lucide-react";
        ...
        <div className="min-h-screen flex flex-col bg-background">
            <Helmet>
                ...
                <meta name="description"
                      content="Live 2025 Philippine National Election results for Senators and Party List. Stay updated with real-time vote counting."/>
            </Helmet>
            ...
            <main className="container mx-auto max-w-6xl px-6 mt-24 mb-8">
                ...
                <Alert className="border-blue-200 bg-blue-50 mb-6">
                    ...
                    <AlertDescription className="text-blue-700">
                        These results are for demonstration purposes. Official election results should be verified
                        through COMELEC.
                    </AlertDescription>
                </Alert>

                <Alert className="border-gray-200 bg-gray-50 mb-6">
                    <Newspaper className="h-4 w-4 text-gray-800"/>
                    <AlertTitle className="text-gray-800">Data Source: ABS-CBN Election Results</AlertTitle>
                    <AlertDescription className="text-gray-700">
                        Live election results are sourced from the official {" "}
                        <a
                            href="https://halalanresults.abs-cbn.com"
                            className="font-medium underline"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            ABS-CBN Election Results
                        </a>
                    </AlertDescription>
                </Alert>
