  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <Helmet>
        ...
        <meta name="description" content="Create your personalized Kodigo ballot for the 2025 Philippine National Elections. Focus on Senators and Party List." />
        ...
        <meta property="og:description" content="Create your personalized Kodigo ballot for the 2025 Philippine National Elections. Focus on Senators and Party List." />
        ...
        <meta name="twitter:description" content="Create your personalized Kodigo ballot for the 2025 Philippine National Elections. Focus on Senators and Party List." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Kodigo Eleksyon 2025 - National",
